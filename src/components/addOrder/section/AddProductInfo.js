...
const AddProductInfo = ({ data, setData, products }) => {
      ...
      <div className={"form-con"}>
        <div className={"details"}>
          ...
          <h6 className={"description"}>
            Add your product and quantity for the order
          </h6>
        </div>
        <div className={"card-con"}>
              ...
              <div className={"input-parent"}>
                ...
                <div className={"input-con"}>
                  ...
                  <input
                    ...
                    value={
                      product.quantity !== ""
                        ? product.stock - parseInt(product.quantity)
                        : product.stock
                    }
                  />
                </div>
                <div className={"input-con"}>
                  ...
                  <input
                    type="text"
                    disabled
                    value={product.vendorId.vendorName}
                  />
                </div>
                <div className={"input-con"}>
                  <h6>Selling Price</h6>
          ...
          <button
            ...
            disabled={isDisabled}
            style={{ background: isDisabled ? Colors.light3 : Colors.primary }}
          >
            Add Product
          </button>
        </div>
