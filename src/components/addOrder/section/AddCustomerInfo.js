...
const AddCustomerInfo = ({ data, setData, carriers }) => {
  const classes = useStyles();

//   const [orderIdData, setorderIdData] = useState([]);

//   useEffect(() => {
//     axios.get(`${backendUrl}/get/find-orderId`).then((res) => {
//       console.log("res.data ---->", res.data.data);
//       console.log("data.orderId --->", data);
//       setorderIdData(res.data.data);
//     });
//   }, []);

  const onDataChange = (e) => {
    setData({ ...data, [e.target.name]: e.target.value });
    console.log("data.orderId 2 --->", data.orderId);
  };
      ...
      <div className={"form-con"}>
        <div className={"details"}>
          ...
          <h6 className={"description"}>
            Add your customer information for your order
          </h6>
        </div>
